...
public class UI_Option : UI_Base
{
    ...
    public override void Binding()
    {
        ...
        GameObject OptionItemGO = Managers.Resource.Instantiate(en_ResourceName.CLIENT_UI_OPTION_ITEM, GetGameObject((int)en_OptionGameObject.OptionItemList).gameObject.transform);
        UI_OptionItem OptionItemUI = OptionItemGO.GetComponent<UI_OptionItem>();
        OptionItemUI.Binding();
        OptionItemUI.SetOptionItemType(en_MenuType.MENU_TYPE_CHARACTER_CHOICE);
    }
